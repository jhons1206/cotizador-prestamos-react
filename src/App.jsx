...
function App() {
    ...
    return (
        <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
            ...
            <input type="range" className="w-full h-6 bg-gray-200 accent-lime-500 hover:accent-lime-600" onChange={handleChange} min={MIN} max={MAX} step={STEP} value={cantidad} />
